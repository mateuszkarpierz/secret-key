...
> [!TIP]
> **Захист від змови довірених осіб за вашого життя.** Алгоритм Шаміра математично дозволяє призначеним довіреним особам відновити сам головний пароль, якщо вони змовляться це зробити — це неминуча властивість будь-якої порогової схеми розподілу секрету, а не лише цієї. Якщо ви додатково не захищаєте свою базу паролів апаратним ключем (наприклад, YubiKey/FIDO2), відновленого пароля їм достатньо, щоб повністю відкрити базу. Secret Key обмежує цей ризик за допомогою сповіщень електронною поштою під час спроб входу та завантаження файлів, але для максимального захисту рекомендується використовувати апаратний ключ як другий фактор для самої бази паролів — тоді саме лише знання головного пароля нікому нічого не дасть без фізичної присутності ключа поруч із вами.
