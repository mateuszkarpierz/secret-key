...
[**→ デモを見る**](https://app.secretkey.website) &nbsp;·&nbsp; [**システム概要**](https://secretkey.website) &nbsp;·&nbsp; [**ドキュメント**](https://secretkey.website/docs)
...
- 01 · 🔑 [アイデア](#アイデア)
- 02 · ⚙️ [動作の仕組み](#動作の仕組み)
- 03 · 💳 [Secret Key カード](#secret-keyカード)
- 04 · 🔐 [Shamirのアルゴリズム](#shamirのアルゴリズム)
- 05 · 🏗️ [システムアーキテクチャ](#システムアーキテクチャ)
- 06 · 🛡️ [セキュリティ](#セキュリティ)
- 07 · 🚀 [インストール](#インストール)
- 08 · 📁 [ファイル構成](#ファイル構成)
- 09 · ❓ [よくある質問](#faq)
