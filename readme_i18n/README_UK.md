...
[**→ Дивитися демо**](https://app.secretkey.website) &nbsp;·&nbsp; [**Огляд системи**](https://secretkey.website) &nbsp;·&nbsp; [**Документація**](https://secretkey.website/docs)
...
- 03 · 💳 [Картка Secret Key](#картка-secret-key)
- 04 · 🔐 [Алгоритм Шаміра](#алгоритм-шаміра)
- 05 · 🏗️ [Архітектура системи](#архітектура-системи)
- 06 · 🛡️ [Безпека](#безпека)
- 07 · 🚀 [Встановлення](#встановлення)
- 08 · 📁 [Структура файлів](#структура-файлів)
- 09 · ❓ [Часті запитання](#faq)
